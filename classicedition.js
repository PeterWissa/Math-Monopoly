...
function Square(name, pricetext, color, price, groupNumber, baserent, rent1, rent2, rent3, rent4, rent5) {
    ...
    */
    ...
    communityChestCards[6] = new Card(" $100.", function() { addamount(100, 'Community Chest');});
    communityChestCards[7] = new Card("Receive $25.", function() { addamount(25, 'Community Chest');});
    communityChestCards[8] = new Card("fees of $100.", function() { subtractamount(100, 'Community Chest');});
    ...
    communityChestCards[11] = new Card("'s fee. Pay $50.", function() { subtractamount(50, 'Community Chest');});
