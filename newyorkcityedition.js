function Square(name, pricetext, color, price, groupNumber, baserent, rent1, rent2, rent3, rent4, rent5) {
    ...
    square[18] = new Square("New York Knicks 3x+1", "$180", "orange", 180, 6, 14, 70, 200, 550, 750, 950);
    ...
    communityChestCards[6] = new Card("You have won a United Airlines trip around the world! finish this equation, Collect $100", function() { addamount(100, 'Community Chest');});
    communityChestCards[7] = new Card("do this equation. Receive $25", function() { addamount(25, 'Community Chest');});
